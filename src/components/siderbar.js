    ...
    render() {
        return (
            <Panel className="sider">
                ...
                <Panel header="友情社区">
                    <ul className="sider-ul">
                        <li style={{textAlign: 'center',}}><a href="http://cnodejs.org" rel="nofollow" title="CNode 社区"
                                                              target="_blank"><img alt="1"
                                                                                   src="//ruby-china-files.b0.upaiyun.com/photo/2016/d427ef3efd33b57721df152c2aa1735e.png"
                                                                                   style={{width: '130px',}}/></a></li>
                        <li style={{textAlign: 'center',}}><a href="http://golangtc.com/" rel="nofollow"
                                                              title="Golang 中国" target="_blank"><img alt="2"
                                                                                                     src="//ruby-china-files.b0.upaiyun.com/photo/2016/3b0fc569b40157a397143d121fea7e6f.png"
                                                                                                     style={{width: '130px',}}/></a>
                        </li>
                        <li style={{textAlign: 'center',}}><a href="https://laravel-china.org" target="_blank"
                                                              rel="nofollow"><img alt="3"
                                                                                  src="//ruby-china-files.b0.upaiyun.com/photo/2016/d7782871f3fac7e85a95d20c74046909.png"
                                                                                  style={{width: '130px',}}/></a></li>
                        <li style={{textAlign: 'center',}}><a href="http://elixir-cn.com" target="_blank"
                                                              rel="nofollow"><img alt="4"
                                                                                  src="//ruby-china-files.b0.upaiyun.com/photo/2015/f65fb5a10d3392a1db841c85716dd8f6.png"
                                                                                  style={{width: '130px',}}/></a></li>
                        <li style={{textAlign: 'center',}}><a href="http://ionichina.com/" target="_blank"
                                                              rel="nofollow"><img alt="5"
                                                                                  src="//ruby-china-files.b0.upaiyun.com/photo/2016/62e5d33d4f90ead9e798e3f8ae085f16.png"
                                                                                  style={{width: '130px',}}/></a></li>
                        <li style={{textAlign: 'center',}}><a href="https://testerhome.com/" target="_blank"
                                                              rel="nofollow"><img alt="6"
