            ...
            <Navbar className="navbar-fixed-top" id="navbar">
                ...
                <Navbar.Collapse>
                    <ul id="nav" className="nav navbar-nav">
                        <li className={this.state.current === '/topics' ? "active" : ''}><Link to='/topics'>社区</Link>
                        </li>
                        ...
                        <li className={this.state.current === '/homeland' ? "active" : ''}><Link
                            to='/homeland'>Homeland</Link></li>
                    ...
                    <ul className="nav navbar-nav pull-right">
                        <li className={this.state.current === '/account/signup' ? 'active' : ''}><Link
                            to='/account/signup'>注册</Link></li>
                        <li className={this.state.current === '/account/signin' ? 'active' : ''}><Link
                            to='/account/signin'>登录</Link></li>
                    </ul>
